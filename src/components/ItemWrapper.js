...
class ItemWrapper extends Component {
  constructor(props) {
    super(props);
    this.state = {
      showOperateAreaStyle: { display: 'none' }
    };
    this.showOperateArea = this.showOperateArea.bind(this);
    this.hideOperateArea = this.hideOperateArea.bind(this);
  }
  ...
  showOperateArea() {
    console.log('showOperateArea');
    this.setState({
      showOperateAreaStyle: { display: 'block' }
    });
  }

  hideOperateArea() {
    console.log('hideOperateArea');
    this.setState({
      showOperateAreaStyle: { display: 'none' }
    });
  }
  ...
  render() {
    return ( < div className = "col-lg-3 col-md-6 col-sm-6 col-xs-12 continfobox" >
      ...
      <
      img className = "figure-img cover"
      src = "https://dc8gwjuur0w0x.cloudfront.net/lists/avatars/000/000/010/small_x2_Apple.jpg?1486166548"
      alt = "Small x2 screen shot 2016 08 15 at 8.50.07 am" / >
      <
      img className = "figure-img qrcode"
      src = "https://dc8gwjuur0w0x.cloudfront.net/lists/avatars/000/000/005/small_x2_Screen_Shot_2016-08-22_at_1.39.14_PM.png?1471899655"
      alt = "Small x2 screen shot 2016 08 15 at 8.50.07 am" / >
      <
      /figure> <
      ...
      <
      span className = "fa fa-tags operate-entry"
      onMouseEnter = { this.showOperateArea } > < /span> <
      /div> <
      div style = { this.state.showOperateAreaStyle }
      className = "col-lg-12 col-md-12 col-sm-12 col-xs-12 operate-area"
      onMouseLeave = { this.hideOperateArea } >
      <
